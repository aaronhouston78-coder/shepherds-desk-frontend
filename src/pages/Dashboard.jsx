...
function formatPlan(plan) {
  ...
  if (plan === "team" || plan === "church-team" || plan === "church_team") return "Church Team";
...
export function Dashboard({ onSelectTool }) {
  ...
  return (
    <div style={{ padding: "40px 48px", maxWidth: 1000 }} className="fade-in">
      ...
      <h1 className="serif" style={{ fontSize: 36, fontWeight: 700, color: C.navy, marginBottom: 20 }}>
        {user?.name || "Pastor"}
      </h1>
      ...
      >
        <p style={{ fontSize: 12, color: C.textMuted, marginBottom: 6, textTransform: "uppercase", letterSpacing: 0.5 }}>
          Account Overview
        </p>

        <h2 style={{ fontSize: 20, fontWeight: 700, color: C.navy, marginBottom: 14 }}>
        ...
        {TOOLS.map((tool) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ marginTop: 16, fontSize: 12, color: C.gold, fontWeight: 500 }}>
                Open builder &rarr;
              </div>
            </button>
          );
